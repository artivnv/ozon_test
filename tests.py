...
def test_get2_status_code_equals_200():
    response = requests.get("https://jsonplaceholder.typicode.com/posts/5?userid=1")
    assert response.status_code == 200

def test_get2_check_content_type_equals_json():
    response = requests.get("https://jsonplaceholder.typicode.com/posts/5?userid=1")
    assert response.headers['Content-Type'] == "application/json; charset=utf-8"
...
def test_get3_status_code_equals_200():
    response = requests.get("https://jsonplaceholder.typicode.com/users?id=26")
    assert response.status_code == 200

def test_get3_check_content_type_equals_json():
    response = requests.get("https://jsonplaceholder.typicode.com/users?id=26")
    assert response.headers['Content-Type'] == "application/json; charset=utf-8"
